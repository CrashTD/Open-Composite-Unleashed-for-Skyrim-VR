...
#define RES_O_FNT_OCU_NORDIC 19
#define RES_O_FNT_OCU_UNEASE 20
#define RES_O_FNT_CYRODIIL 21
...
#define RES_LIST_LINUX(f) \
	...
	f(RES_O_FNT_OCU_NORDIC) \
	f(RES_O_FNT_OCU_UNEASE) \
	f(RES_O_FNT_CYRODIIL) \
